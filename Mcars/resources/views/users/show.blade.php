                ...
                <div class="media panel">
                    ...
                    <div class="media-body media-middle">
                        ...
                        <div class="row" id="vendor-info">
                            ...
                            <div class="col-md-4">
                                <h5 class="media-heading"><span id="email"><i class="fas fa-envelope"></i></span> {{Auth::User()->email}} </h5>
                                <!-- <p>Since May, 2016</p> -->
                            </div>
                            <div class="col-md-4">
                                <h5 class="media-heading"><span id="phone"><i class="fas fa-phone"></i></span> {{Auth::User()->name}} </h5>
                                <!-- <p>Since May, 2016</p> -->
                            </div>
                            <div class="col-md-4">
                                <div class="col-md-6">
                                <h5 class="media-heading"><span id="vendorID"><i class="fas fa-id-badge"></i></span> {{Auth::User()->id}} </h5>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="media-heading"><span id="vendorID"><i class="fas fa-id-badge"></i></span> {{$user->role["name"]}} </h5>
                                </div>
                            </div>
                        </div>
                    </div>
